        ...
        */
        ...
        $scope.openImageDrawer = function(){
          if(typeof(arguments[0]) === "function"){
            var oldId = null;
            var onChangeFn = arguments[0];
            var onSaveFn = arguments[1];
            var onCancelFn = arguments[2];
          }else{
            var oldId = arguments[0];
            var onChangeFn = arguments[1];
            var onSaveFn = arguments[2];
            var onCancelFn = arguments[3];
          }

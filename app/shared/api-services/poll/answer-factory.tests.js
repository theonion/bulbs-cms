...
describe('Answer Factory', function () {
  ...
  describe('postAnswer()', function () {
    it('makes a post request', function () {
      ...
      $httpBackend.expectPOST('/cms/api/v1/poll_answer/').respond(201);
      $httpBackend.flush();
    });
    ...
    it('returns answer payload', function() {
      ...
      $httpBackend.expectPOST('/cms/api/v1/poll_answer/').respond(201, mockPayload);
      $httpBackend.flush();
  ...
  describe('updatePollAnswers()', function () {
    it('deletes any answers in deletedAnswers', function () {
      ...
      $httpBackend.expectDELETE('/cms/api/v1/poll_answer/1').respond(201);
      $httpBackend.flush();
    });
    ...
    it('updates existing answers', function () {
      ...
      Answer.updatePollAnswers(scope);
      $httpBackend.expectPUT('/cms/api/v1/poll_answer/5').respond(201);
      $httpBackend.flush();
    });
  });
});

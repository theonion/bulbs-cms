...
angular.module('bulbs.cms.dateTimeModal', [
  'bulbs.cms.dateTimeModal.opener'
]);
...
angular.module('bulbs.cms.editor', [
  'bulbs.cms.editor.wrapper'
]);
...
angular.module('bulbs.cms.imageCropModal.controller', [
  'BettyCropper',
  'jquery',
  'ui.bootstrap.modal'
])
...
angular.module('promotedContentList.directive', [
  ...
  .directive('promotedContentList', function ($, CmsConfig) {
    return {
      ...
      restrict: 'E',
      scope: {},
      templateUrl: CmsConfig.buildComponentPath('promoted-content/promoted-content-list/promoted-content-list.html')
    };
  });
      ...
      return {
        ...
        link: function (scope, element) {
          ...
          var updateActiveChoiceElement = function(el) {
            ...
            var oldEl = parentEl.siblings().filter('.active');
...
angular.module('bulbs.cms.superFeatures', [
...
angular.module('bulbsCmsApp')
  .directive('devicepreview', function ($) {
    return {
      restrict: 'E',
      templateUrl: '/views/devicepreview.html',
      link: function (scope, element, attrs) {
...
angular.module('bulbsCmsApp')
  .directive('encodeStatus', function ($http, $interval, $, Zencoder) {
    return {
      templateUrl: '/views/encode-status.html',
      restrict: 'E',
      link: function postLink(scope, element, attrs) {
...
angular.module('bulbsCmsApp')
  .directive('featuretypeField', function (IfExistsElse, ContentFactory, Raven, $) {
    return {
      templateUrl: '/views/textlike-autocomplete-field.html',
      restrict: 'E',
      scope: {
...
angular.module('bulbsCmsApp')
  .directive('lazyInclude', function ($, $compile, $q, $http, $templateCache,
      Gettemplate) {
    /*
    ...
    */
    ...
    return {
      ...
      scope: true,
      link: function (scope, element, attrs) {
        var templateUrl = '/views/' + attrs.template;
        var $element = $(element);
...
angular.module('bulbsCmsApp')
  .directive('tagsField', function (_, IfExistsElse, ContentFactory, Raven, $) {
    return {
      templateUrl: '/views/taglike-autocomplete-field.html',
      restrict: 'E',
      scope: {
...
angular.module('bulbsCmsApp').directive(
  'videoUpload',
  function ($http, $window, $timeout, $sce, $) {
    return {
      templateUrl: '/views/mainvideo.html',
      scope: {
        'article': '='
      },
      restrict: 'E',
...
angular.module('bulbsCmsApp')
  .controller('CmsNotificationsCtrl', function ($q, $window, $scope, CmsConfig,
      CmsNotificationsApi, CurrentUserApi, _, moment) {
...
angular.module('bulbsCmsApp')
  .controller('LineitemexportmodalCtrl', function ($scope, $http, CmsConfig, moment) {
    var now = moment().tz(CmsConfig.getTimezoneName());
...
'use strict';
  ...
  */
angular.module('bulbsCmsApp').factory('PermissionsInterceptor', function ($q, $injector) {
  return {
    responseError: function (rejection) {
        ...
        $injector.invoke(function ($modal) {
          if (rejection.status === 403) {
            if (rejection.data && rejection.data.detail && rejection.data.detail.indexOf('credentials') > 0) {
              ...
              $modal.open({
                templateUrl: '/views/modals/403-modal.html',
